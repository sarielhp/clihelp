...
func buildBuildCommand() clihelp.Command {
	var (
		buildOutput    string
		buildBitrate   int
		buildNormalize bool
...
func buildServeCommand() clihelp.Command {
	var (
		servePort       int
		serveHost       string
...
func buildConfigSpaceCommand() clihelp.Command {
	var (
...
func buildConfigCommand() clihelp.Command {
	return clihelp.Command{
		Name:        "config",
...
func buildDeployCommand() clihelp.Command {
	var (
		deployBucket   string
		deployStage    string
		deployDryRun   bool
...
func buildStatusCommand() clihelp.Command {
	var (
		statusStage string
		statusJSON  bool
	)
...
func buildPersistentOptions(globals *GlobalOptions) []clihelp.Option {
